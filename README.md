...
| **[bakufu](https://github.com/vanshrana21/bakufu)** ⭐ 1 | BAKUFU: mineral intelligence prototype for SIH26009 (MOIL manganese Ghost Reserves). Next.js frontend + FastAPI backend. | `Jupyter Notebook` `Python` `TypeScript` `CSS` `Shell` | 4 days ago |
...
<sub>🤖 This README rebuilds itself daily from the GitHub API — last updated **26 Sept 2026, 1:11 pm IST**</sub>
